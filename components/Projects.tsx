        ...
        <section id="projects" className="py-[80px] bg-[#0a0f1e] relative overflow-hidden">
            ...
            <div className="max-w-[1240px] px-5 mx-auto relative z-10">
                                ...
                                <div className="block w-full h-full relative z-10">
                                    ...
                                    <div className="absolute inset-0 p-[30px] flex flex-col justify-end z-10">
                                        <div className="relative z-20">
                                            ...
                                            <p className={`text-white/80 font-normal mb-[15px] leading-[1.5] drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)] ${isBig ? 'text-[17px]' : 'text-[14px]'}`}>
                                            ...
                                            <div className="flex flex-wrap gap-[8px]">
                                                {project.tech.slice(0, 3).map((t: string) => (
                                                    <span
                                                        key={t}
                                                        className="px-[14px] py-[6px] rounded-[20px] bg-white/15 border border-white/25 text-[11px] font-semibold text-white uppercase"
                                                    >
                                                        {t}
                                                    </span>
                                                ))}
                ...
                <div className="mt-[48px] flex justify-center">
                    <Link
                        href="/projects"
                        className="group relative inline-flex items-center gap-2 px-[36px] py-[13px] border border-white/30 text-white font-bold rounded-full transition-all hover:bg-white hover:text-[#111318] hover:border-white hover:shadow-[0_8px_24px_rgba(255,255,255,0.1)] hover:-translate-y-[2px] active:scale-95"
                    >
