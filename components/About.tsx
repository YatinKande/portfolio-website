            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto px-4 py-24 md:py-32 flex flex-col items-center">
                ...
                >
                    ...
                    <div className="space-y-6 max-w-3xl mx-auto text-slate-200 text-sm md:text-lg leading-relaxed mb-10">
                        ...
                        <motion.p variants={itemVariants}>
                            My internships at SmartKnower gave me the opportunity to move beyond theory and into high-impact engineering. As an AI/ML intern, I built a YOLOv5 object detection model for crop disease identification, optimized computer vision pipelines to cut inference time by 40 percent, and architected distributed Spark workflows processing over 10,000 images per day. As a Data Science intern, I engineered a customer churn prediction model using XGBoost that achieved an 81 percent AUC-ROC, built 15 plus domain-specific features from raw behavioral data, and ran rigorous model comparisons before selecting the best solution for production. These experiences taught me that the most valuable models are the ones that actually ship.
                        </motion.p>
                        <motion.p variants={itemVariants}>
                    ...
                    >
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3 text-white font-medium text-sm md:text-base">
                                ...
                                <span>AI/ML & Data Science Internships at SmartKnower</span>
                            </li>
                            <li className="flex items-center gap-3 text-white font-medium text-sm md:text-base">
