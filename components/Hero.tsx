...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden py-20 px-6 bg-[#111318]">
            {/* Single soft white glow for depth */}
            ...
            <div className="flex flex-col items-center text-center z-10 w-full max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="relative w-[140px] h-[140px] sm:w-[160px] sm:h-[160px] md:w-[200px] md:h-[200px] min-w-[140px] min-h-[140px] rounded-full border-[3px] border-white shadow-[0_0_40px_rgba(255,255,255,0.15)] overflow-hidden z-10">
                        <NextImage
                            src="/me.jpg"
                            alt="Yatin Kande"
                            fill
                ...
                >
                    ...
                    <span className="text-white/30 font-bold text-[12px]">·</span>
                    ...
                    <span className="text-white/30 font-bold text-[12px]">·</span>
                    <span className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-white/[0.07] border border-white/20 text-[12px] font-bold text-white uppercase tracking-widest">
                ...
                >
                    <motion.div whileHover={{ y: -5, scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Link
                            href="#contact"
                            className="group bg-white text-[#111318] font-bold px-[40px] py-[18px] rounded-full transition-all duration-300 shadow-[0_10px_30px_-5px_rgba(255,255,255,0.15)] hover:shadow-[0_20px_40px_-10px_rgba(255,255,255,0.2)] inline-flex items-center gap-2 text-[18px] hover:bg-white/90"
                        >
                            Contact Me
                    ...
                    <motion.div whileHover={{ y: -5, scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <a
                            ...
                            className="group border-2 border-white/40 text-white font-bold px-[40px] py-[16px] rounded-full transition-all duration-300 hover:bg-white hover:text-[#111318] hover:border-white hover:shadow-[0_10px_30px_-5px_rgba(255,255,255,0.15)] inline-flex items-center gap-2 text-[18px]"
                        >
                ...
                <motion.div className={`mt-auto md:mb-[40px] ${getHeroClass(5)}`}>
                    <button
                        ...
                        className="text-white/30 hover:text-white/60 transition-all duration-300 transform hover:scale-110"
                    >
